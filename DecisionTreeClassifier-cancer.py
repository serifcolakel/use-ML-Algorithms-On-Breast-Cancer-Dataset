...
X_train, X_test, y_train, y_test = train_test_split(df_feat, df_target, test_size = 0.2)
DecisionTreeClassifier =DecisionTreeClassifier(criterion="entropy", random_state=999)
...
plt.title("DecisionTree Classification Confusion Matrix")
plt.show()
